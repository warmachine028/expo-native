...
<div align=center>
    <a href="https://github.com/warmachine028/expo-native">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="expo-native">
    </a>
...
2. Go to [**Security**](https://github.com/warmachine028/expo-native/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/expo-native/settings/security_analysis#code_scanning_settings) section in settings.
